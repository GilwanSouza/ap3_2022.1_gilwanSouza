/*
* Considere as informações de um funcionário: nome completo, idade, cargo e
* salário bruto.
* Há um desconto de 15% sobre o salário bruto para formar o salário líquido.
* Escreva uma classe Funcionario.java que tenha os métodos necessários para
* executar um programa
* que exibe na saída padrão o nome, a idade, o cargo, o salário bruto, o
* salário líquido e o salário líquido anual.
* Faça métodos assessores (getters e setters), e o construtor adequado para
* todos os atributos.
